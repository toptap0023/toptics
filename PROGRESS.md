...
**ค้าง: ยังไม่ได้ตรวจในเบราว์เซอร์** เพราะไม่มี login ผมสร้าง test user
`10xiconkaset.ai+uxtest@gmail.com` (รหัส `uxtest-2026-pass`) ไว้แล้ว แต่ Supabase ส่งอีเมลยืนยันไปที่ inbox
ของเจ้าของ ต้องกดลิงก์ยืนยันก่อน จึงจะรัน proto-qa ที่ 390x844 ได้ (test user ไม่เห็นข้อมูลจริงเพราะ RLS)
